          ...
          "template": {
            ...
            "items": [
              ...
              },
              {
                "required": true,
                "type": "html",
                "content": "\u003Ch3\u003ESelon vous, à quel point ce message est-il préventif ?\u003C\u002Fh3\u003E\r\n\u003Ccenter\u003E\r\n    \u003Cfieldset\u003E\r\n\u003Cdiv class=\"container\" style=\"white-space:nowrap;display:flex;justify-content:space-between;\"\u003E\r\n  \u003Clabel for=\"jugement_prevention\"\u003E\u003Cp\u003EPas du tout\u003C\u002Fp\u003E \u003Cp\u003Epréventif\u003C\u002Fp\u003E\u003C\u002Flabel\u003E\r\n  \u003Cinput type=\"range\" min=\"1\" max=\"100\" value=\"50\" step=\"1\" name=\"jugement_prevention\" onclick=\"document.getElementById('promotion_div').style.visibility='visible';\"\u003E\r\n  \u003Clabel for=\"jugement_prevention\"\u003E\u003Cp\u003ETout à fait\u003C\u002Fp\u003E \u003Cp\u003Epréventif\u003C\u002Fp\u003E\u003C\u002Flabel\u003E\r\n  \u003Cinput type=\"hidden\" id=\"touched\" name=\"touched\" value=\"0\"\u003E\r\n\u003C\u002Fdiv\u003E\r\n\r\n\r\n    \u003C\u002Ffieldset\u003E\r\n\u003C\u002Fcenter\u003E\r\n",
                "name": ""
              },
              {
                "required": true,
                "type": "html",
                "content": "\u003Ccenter\u003E\r\n  \u003Cfieldset style=\"visibility:hidden;\" id=\"promotion_div\"\u003E\r\n    \u003Ch3\u003ESelon vous, à quel point ce message est-il promotionnel ?\u003C\u002Fh3\u003E\r\n  \u003Cdiv class=\"container\" style=\"white-space:nowrap;display:grid;  grid-template-columns: repeat(auto-fit, minmax(min-content, 0.5fr));\"\u003E\r\n  \u003Clabel for=\"jugement_promotion\" style=\"grid-column:1\"\u003E\u003Cp\u003EPas du tout\u003C\u002Fp\u003E \u003Cp\u003Epromotionnel\u003C\u002Fp\u003E\u003C\u002Flabel\u003E\r\n    \u003Cinput type=\"range\" min=\"1\" max=\"100\" value=\"50\" step=\"1\"  style=\"grid-column:2\" name=\"jugement_promotion\" onclick=\"document.getElementById('touched').value = 1;document.getElementById('bouton_suivant').style.visibility='visible';\"\u003E\r\n    \u003Clabel for=\"jugement_promotion\" style=\"grid-column:3\"\u003E\u003Cp\u003ETout à fait\u003C\u002Fp\u003E \u003Cp\u003Epromotionnel\u003C\u002Fp\u003E\u003C\u002Flabel\u003E\r\n    \u003Cinput type=\"hidden\" id=\"touched\" name=\"touched\" value=\"0\"\u003E\r\n\r\n  \u003C\u002Fdiv\u003E\r\n  \u003C\u002Ffieldset\u003E\r\n\u003C\u002Fcenter\u003E",
                "name": ""
              },
              {
                "required": true,
